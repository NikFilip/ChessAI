...
class Piece:
    ...
    def __str__(self):
        ...
        return 'Type : ' + type(self).__name__ + \
               ...
               " -- Moves made : " + str(self.moveHistory)

    #Uses the coordinates to move pieces from current pos, if there is a piece already at the
    #desired position it will capture it
    def moveInDirecFromPos(self, pos, direction, side):
